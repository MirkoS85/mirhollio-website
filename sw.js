const CACHE_NAME = "mirhollio-core-shell-v196";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-2",
  "/assets/live-refresh.css?v=core-2",
  "/assets/operator.js?v=core-2",
  "/assets/live-refresh.js?v=core-2",
  "/assets/ops.css?v=core-2",
  "/assets/ops.js?v=core-2",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-2",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/logo.png",
