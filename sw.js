const CACHE_NAME = "mirhollio-core-shell-v200";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-6",
  "/assets/live-refresh.css?v=core-6",
  "/assets/operator.js?v=core-6",
  "/assets/live-refresh.js?v=core-6",
  "/assets/ops.css?v=core-6",
  "/assets/ops.js?v=core-6",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/network-position.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-6",
  "/assets/core-home.js?v=core-6",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/logo.png",
