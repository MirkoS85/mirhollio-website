const CACHE_NAME = "mirhollio-core-shell-v214";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-20",
  "/assets/live-refresh.css?v=core-20",
  "/assets/operator.js?v=core-20",
  "/assets/live-refresh.js?v=core-20",
  "/assets/ops.css?v=core-20",
  "/assets/ops.js?v=core-14",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/network-position.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-20",
  "/assets/core-home.js?v=core-20",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/assets/brand-mark.jpg?v=core-20",
  "/logo.png",
