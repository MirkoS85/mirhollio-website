const CACHE_NAME = "mirsflr-shell-v171";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/assets/live-refresh.css?v=ftso-delegation-summary-1",
  "/assets/operator.js?v=ftso-delegation-summary-1",
  "/assets/live-refresh.js?v=pre-reg-pill-size-1",
  "/assets/ops.css?v=ops-29",
  "/assets/ops.js?v=ops-29",
