const CACHE_NAME = "mirhollio-core-shell-v220";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-23",
  "/assets/live-refresh.css?v=core-23",
  "/assets/operator.js?v=core-23",
  "/assets/live-refresh.js?v=core-23",
  "/assets/ops.css?v=core-23",
  "/assets/ops.js?v=core-14",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/network-position.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-23",
  "/assets/core-home.js?v=core-23",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/assets/brand-mark.jpg?v=core-23",
  "/logo.png?v=2",
