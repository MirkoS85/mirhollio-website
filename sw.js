const CACHE_NAME = "mirhollio-core-shell-v198";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-4",
  "/assets/live-refresh.css?v=core-4",
  "/assets/operator.js?v=core-4",
  "/assets/live-refresh.js?v=core-4",
  "/assets/ops.css?v=core-4",
  "/assets/ops.js?v=core-4",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/network-position.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-4",
  "/assets/core-home.js?v=core-4",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/logo.png",
