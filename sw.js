const CACHE_NAME = "mirhollio-core-shell-v226";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-29",
  "/assets/live-refresh.css?v=core-29",
  "/assets/operator.js?v=core-29",
  "/assets/live-refresh.js?v=core-29",
  "/assets/ops.css?v=core-29",
  "/assets/ops.js?v=core-14",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/network-position.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-29",
  "/assets/core-home.js?v=core-29",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/assets/brand-mark.jpg?v=core-29",
  "/logo.png?v=2",
