const CACHE_NAME = "mirhollio-core-shell-v224";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-27",
  "/assets/live-refresh.css?v=core-27",
  "/assets/operator.js?v=core-27",
  "/assets/live-refresh.js?v=core-27",
  "/assets/ops.css?v=core-27",
  "/assets/ops.js?v=core-14",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/network-position.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-27",
  "/assets/core-home.js?v=core-27",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/assets/brand-mark.jpg?v=core-27",
  "/logo.png?v=2",
