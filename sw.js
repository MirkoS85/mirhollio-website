const CACHE_NAME = "mirhollio-core-shell-v201";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-7",
  "/assets/live-refresh.css?v=core-7",
  "/assets/operator.js?v=core-7",
  "/assets/live-refresh.js?v=core-7",
  "/assets/ops.css?v=core-7",
  "/assets/ops.js?v=core-7",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/network-position.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-7",
  "/assets/core-home.js?v=core-7",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/logo.png",
