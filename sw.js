const CACHE_NAME = "mirhollio-core-shell-v195";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-1",
  "/assets/live-refresh.css?v=core-1",
  "/assets/operator.js?v=core-1",
  "/assets/live-refresh.js?v=core-1",
  "/assets/ops.css?v=core-1",
  "/assets/ops.js?v=core-1",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-1",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/logo.png",
