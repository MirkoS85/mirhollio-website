const CACHE_NAME = "mirhollio-core-shell-v222";
const APP_SHELL = [
  "/",
  "/ops/",
  "/ftso/",
  ...
  "/stats/",
  "/performance/",
  "/assets/operator.css?v=core-25",
  "/assets/live-refresh.css?v=core-25",
  "/assets/operator.js?v=core-25",
  "/assets/live-refresh.js?v=core-25",
  "/assets/ops.css?v=core-25",
  "/assets/ops.js?v=core-14",
  "/ops/status.example.json",
  "/data/ftso-delegations.json",
  "/data/network-position.json",
  "/data/watch-status.json",
  "/assets/pwa.js?v=core-25",
  "/assets/core-home.js?v=core-25",
  "/app.webmanifest",
  "/ops/app.webmanifest",
  "/assets/brand-mark.jpg?v=core-25",
  "/logo.png?v=2",
