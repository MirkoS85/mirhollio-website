...
// Deliberately not @MainActor: nothing here touches UI, and a widget extension's
// timeline reload runs off the main actor under a tight time budget, so hopping
// actors only adds latency and risks the reload being cut off before it finishes.
